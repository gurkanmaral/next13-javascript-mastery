  ...
  <section className={`${styles.yPaddings} sm:pl-16 pl-6`}>
    ...
    className={`${styles.innerWidth} mx-auto flex flex-col`}>
      <div className='flex justify-start items-center flex-col relative z-10'>
          ...
          <motion.div variants={textVariant(1.2)} className="flex flex-row justify-center
          items-center">
      ...
      className="relative w-full md:-mt-[20px] -mt-[12px]">
        ...
        z-[10] -top-[30px]' />
          <img src="/cover.png" alt="cover" className='w-full sm:h-[500px]
          h-[350px] object-cover rounded-tl-[140px] z-10 relative'  />
          <a href="#explore">
